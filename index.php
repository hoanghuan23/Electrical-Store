          ...
          <div class="row">
            <div class="col-xs-6 col-md-6 col-lg-6 left">
              <div class="collection-list">
                ...
                <div class="content-collection">
                  <h3 class="title">
                    <a href="/electrician_web/page/product.php">ALL BLACK IN BLACK</a>
                  </h3>
            ...
            <div class="col-xs-6 col-md-6 col-lg-6 right">
              <div class="collection-list">
                ...
                <div class="content-collection">
                  <h3 class="title">
                    <a href="/electrician_web/page/product.php">OUT LET SALE</a>
                  </h3>
          ...
          <div class="row">
            <div class="col-md-4 col-lg-4 item">
              ...
              <div class="item-group">
                <a href="/electrician_web/page/product.php" class="item-title">MUA NGAY</a>
